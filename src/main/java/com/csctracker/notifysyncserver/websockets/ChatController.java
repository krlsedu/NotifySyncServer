...
public class ChatController {
    ...
    public OutputMessage send(final MessageDTO messageDTO) {
        ...
        return new OutputMessage(messageDTO.getUuid(), messageDTO.getFrom(), messageDTO.getText(), time, messageDTO.getOperation(), messageDTO.getApp(), messageDTO.getData(), messageDTO.getMachine());
    }
